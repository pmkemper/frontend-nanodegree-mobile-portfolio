...
var resizePizzas = function(size) { 
  ...
  /* 
  The determineDx function is entirely removed, since that calculated percentages 
  in an extremely roundabout way.

  Instead, I assign percentages in a more direct way.
  */
  function changePizzaSizes(size) {
    ...
    /* 
    randomPizzaContainers is defined once, outside of the for loop 
...
function updatePositions() {
  ...
  /*
  First, items is now defined outside of updatePositions (when the page loads).
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  /* 
  on pageload, the height of the window is checked, and pizzas that would appear
  below the bottom of the window are not created by using break; in the for loop
  */
  var rowTop = 0;
  ...
  for (var i = 0; i < 200; i++) {
    ...
    /* will-change : transform is added to each moving pizza so that they get their own
    frames, meaning that they won't trigger a repaint of the entire page */
